...
public class CSVSQLSpoiledFileTest {
    ...
    public static void main(String[] args) {
        ...
        tableEnv.executeSql(
                "CREATE TABLE some_source (\n"
                        ...
                        + " 'path' = 'file:////Users/owner-pc/workspace_commu/crossteams/crossteam-1.15/csv/sql_manual_spoiled.csv',\n"
                        + " 'format' = 'csv',\n"
        ...
        tableEnv.executeSql(
                "CREATE TABLE some_sink (\n"
                        ...
                        + ") WITH (\n"
                        + " 'connector' = 'filesystem',\n"
                        + " 'path' = 'file:////Users/owner-pc/workspace_commu/crossteams/crossteam-1.15/results/sql2',\n"
                        + " 'format' = 'csv',\n"
